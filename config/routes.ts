...
export default [
  ...
  { path: '/mobile', redirect: '/mobile/meetings', layout: false },
  { path: '/mobile/meetings', component: './Mobile/MeetingList', layout: false },
  { path: '/mobile/record/:id', component: './Mobile/Record', layout: false },
  { path: '/mobile/detail/:id', component: './Mobile/MeetingDetail', layout: false },
